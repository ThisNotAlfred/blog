...
With Concepts in C++20 and all the other stuff we had before like (name them!!!!) we at the moment have the tools to build a somewhat functional programming paradigm for ourselves in C++. But before that we may need to familiarize ourselves with a few things.
